...
ggplot(merged_data, aes(x = Demographic.Group, y = State, fill = Difference)) +
  ...
  scale_fill_gradientn(colours = c("#7074c0", "#f1f1f1", "#baad03"),
                      ...
                      labels = c("Very underrepresented\nin Dataset","","Equally represented","","Very overrepresented\nin Dataset")) +
  theme_classic() +
  labs(fill='') +
  xlab(c(""))+ ylab(c("")) +
  theme(axis.text=element_text(size=12),legend.text=element_text(size=12),legend.position="bottom")
```
