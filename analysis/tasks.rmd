...
## Starch-Limonene Inclusion Complex results
```{r, results='asis'}
results_g2 = results[which(results$Gum == "Starch-Limonene Inclusion Complex"),]
print(xtable(results_g2[,c(1,3,4,5)]),include.rownames=FALSE, type = "html")
```

## Free Limonene results
```{r, results='asis'}
results_g1 = results[which(results$Gum == "Free Limonene"),]
print(xtable(results_g1[,c(1,3,4,5)]),include.rownames=FALSE, type = "html")
```
