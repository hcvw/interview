...
### We could either calculate this for each individual for their 120 minutes \\
### and see if the value is different for people with different genes \\
### or calculate across all individuals at each time point to see if it is time-varying.
